...
<br />
        <nav className="navchange">
          <button className="changebtn1"><span className="change" onClick={increament }> <span className="pointchangee">+ </span></span> {counter}  <span className="pointchange">-</span> </button>
...
<div className="centerlistbig">
  ...
  <nav className="titalfex">
          ...
          <div className="showMoresingle">
             <Link className="lnk-showmore" to="/productComparison">Show more</Link>
           </div> 
